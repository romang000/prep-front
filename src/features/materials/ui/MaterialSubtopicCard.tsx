...
export function MaterialSubtopicCard({
    ...
    return (
        <div
            ...
            className="group flex w-full cursor-pointer items-start justify-between rounded-2xl border border-slate-200 bg-white p-5 text-left shadow-sm transition hover:-translate-y-1 hover:border-blue-300 hover:shadow-md active:scale-[0.99]"
        >
            <div className="flex min-w-0 items-start gap-4">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-cyan-50 text-xl text-cyan-600">
                    📄
                </div>
            ...
            <div className="ml-4 flex shrink-0 items-center gap-3">
                <button
                    ...
                    disabled={isLoading}
                    className="flex h-10 w-10 items-center justify-center rounded-full border border-slate-200 bg-slate-50 text-xl transition hover:bg-slate-100 disabled:cursor-not-allowed disabled:opacity-50"
                >
                    {isLiked ? "❤️" : "🤍"}
                </button>
